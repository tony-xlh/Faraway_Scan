...
Java_com_dynamsoft_farawayscan_SuperResolution_superResolutionFromJNI(
...
Java_com_dynamsoft_farawayscan_SuperResolution_initWithByteBufferFromJNI(
...
Java_com_dynamsoft_farawayscan_SuperResolution_deinitFromJNI(
